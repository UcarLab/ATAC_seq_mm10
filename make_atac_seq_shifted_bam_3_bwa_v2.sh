...
echo /opt/compsci/bwa/0.7.12/bin/bwa mem -M /data/shared/Mus_musculus/Ensembl/GRCm38/Sequence/BWAIndex/genome.fa \$FILE $trimmomaticDIR/\$FILE2 \> $trimmomaticDIR/bwa/\$FILESAM >> $workingDIR/bwa.qsub
