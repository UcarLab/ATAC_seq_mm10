...
find $dataDIR -name *_1.fastq > $outputDIR/trimmomatic_R1_filelist.txt
...
echo FILE2=\$\(basename "\${FILE}" \| sed \'s/_1\.fastq/_2\.fastq/g\'\) >> $outputDIR/trimmomatic.qsub
echo FILE1paired=\$\(basename \"\${FILE}\" \| sed \'s/_1\.fastq/_1\.trim\.fastq\.gz/g\'\) >> $outputDIR/trimmomatic.qsub
echo FILE2paired=\$\(basename \"\${FILE2}\" \| sed \'s/_2\.fastq/_2\.trim\.fastq\.gz/g\'\) >> $outputDIR/trimmomatic.qsub
echo FILE1unpaired=\$\(basename \"\${FILE}\" \| sed \'s/_1\.fastq/_1\.trimU\.fastq\.gz/g\'\) >> $outputDIR/trimmomatic.qsub
echo FILE2unpaired=\$\(basename \"\${FILE2}\" \| sed \'s/_2\.fastq/_2\.trimU\.fastq\.gz/g\'\) >> $outputDIR/trimmomatic.qsub
